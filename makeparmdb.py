...
varnames = [
    "Gain:0:0:Real:CS001HBA0",
    "Gain:0:0:Imag:CS001HBA0",
    "Gain:1:1:Real:CS001HBA0",
    "Gain:1:1:Imag:CS001HBA0",
    "Gain:0:0:Real:CS002HBA0",
    "Gain:0:0:Imag:CS002HBA0",
    "Gain:1:1:Real:CS002HBA0",
    "Gain:1:1:Imag:CS002HBA0",
    "Gain:0:0:Real:CS002HBA1",
    "Gain:0:0:Imag:CS002HBA1",
    "Gain:1:1:Real:CS002HBA1",
    "Gain:1:1:Imag:CS002HBA1",
    "Gain:0:0:Real:CS004HBA1",
    "Gain:0:0:Imag:CS004HBA1",
    "Gain:1:1:Real:CS004HBA1",
    "Gain:1:1:Imag:CS004HBA1",
    "Gain:0:0:Real:RS106HBA",
    "Gain:0:0:Imag:RS106HBA",
    "Gain:1:1:Real:RS106HBA",
    "Gain:1:1:Imag:RS106HBA",
    "Gain:0:0:Real:RS208HBA",
    "Gain:0:0:Imag:RS208HBA",
    "Gain:1:1:Real:RS208HBA",
    "Gain:1:1:Imag:RS208HBA",
    "Gain:0:0:Real:RS305HBA",
    "Gain:0:0:Imag:RS305HBA",
    "Gain:1:1:Real:RS305HBA",
    "Gain:1:1:Imag:RS305HBA",
    "Gain:0:0:Real:RS307HBA",
    "Gain:0:0:Imag:RS307HBA",
    "Gain:1:1:Real:RS307HBA",
    "Gain:1:1:Imag:RS307HBA",
]

defvalues.addrows()
defvalues.putcell("NAME", defvalues.nrows() - 1, "Gain:0:0:Real")
defvalues.putcell("VALUES", defvalues.nrows() - 1, numpy.array([[1.0]]))
defvalues.addrows()
...
for num, name in enumerate(varnames):
    ...
    t.addrows()
    trownum = t.nrows() - 1
    t.putcell("VALUES", trownum, numpy.array([[1.0]]))  # Should be correct shape
    t.putcell("STARTX", trownum, 1.34276e08)  # Start frequency in Hz
    t.putcell("ENDX", trownum, 1.34471e08)  # End frequency in Hz
